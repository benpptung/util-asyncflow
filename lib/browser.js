...
function AsyncFlow(opt, context) {
  ...
  Object.defineProperties(this, {
    ...
    go: { get: function(){ prototype._go.bind(this) }},
...
prototype.ctx = function(ctx) {
  if (ctx === Object(ctx)) this._ctx = ctx;
  return this;
};
...
prototype.run = function(cb) {
  ...
  try {
    var ctx = this._ctx || null;
    task.fn.apply(ctx, args);
  } catch (er) {
...
prototype._task = function(wait) {
  return function() {
    ...
    var fn = args.shift();
    this._tasks.push({fn:fn, args:args, wait:wait});
  };
};
